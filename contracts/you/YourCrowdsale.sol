 ...
 * @title YourCrowdsale
 */
contract YourCrowdsale is RefundableCrowdsale,  WhiteListedCrowdsale {

    function YourCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, address _wallet, address controller, uint256 _softCap, address _whitelist)
