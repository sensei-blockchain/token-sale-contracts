...
import "../../contracts/you/YourCrowdsale.sol";
 ...
 */
contract MockYourCrowdsale is YourCrowdsale {

  function MockYourCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, address _wallet, address controller, uint256 _softCap, address _whitelist)
    YourCrowdsale(_startTime, _endTime, _rate, _wallet, controller, _softCap, _whitelist)
  {
